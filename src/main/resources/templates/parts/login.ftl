            ...
            <div class="col-md-6 offset-md-3">
                <div class="card my-4">
                    ...
                    <form action="${path}" method="post" name="jwtRequestDTO" class="card-body p-lg-4">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-color px-5 mb-5 w-100" style="background-color: #0e1c36;color: #fff">Login</button>
                        </div>
                        <div class="form-text text-center mb-5 text-dark">Not
                            Registered? <a href="/user/registration" class="text-dark fw-bold"> Create an
                                Account</a>
                        </div>
                    </form>
                </div>
